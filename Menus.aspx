                        ...
                        <td height="10" class="style11">
                            <p>
                                <asp:HyperLink ID="HyperLink5" runat="server" Font-Underline="True" 
                                    ForeColor="Black" NavigateUrl="~/menu2.aspx">Beverage</asp:HyperLink>
                            </p>
                          </td>
                          <td>
...
<HeaderStyle HorizontalAlign="Center" BackColor="#990000" Font-Size="12pt" ForeColor="White" 
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT [ItemName], [price_M], [ImagePath] FROM [menu] WHERE ItemId BETWEEN 1000 AND 1009"></asp:SqlDataSource>
			</div></td>
              </tr>
              <tr>
                <td height="10"></td>
