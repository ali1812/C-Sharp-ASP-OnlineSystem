<%@ Page Language="C#" AutoEventWireup="true" CodeFile="doneediting.aspx.cs" Inherits="doneediting" %>
                ...
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="353" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td align="left"><span class="heading1"><strong>Thank you </strong>
                      ...
                      <tr>
                        <td class="text1">Your account has been updated successfully..</td>
                      </tr>
                      <tr>
                        <td height="10"></td>
                      </tr>
